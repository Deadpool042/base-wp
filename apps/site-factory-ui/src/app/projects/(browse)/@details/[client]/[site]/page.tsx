// apps/site-factory-ui/src/app/projects/@details/[client]/[site]/page.tsx
...
// import { ProjectDetailsBySlug } from "@/features/projects/components/ProjectDetailsBySlug";

// export default function ProjectDetailsPage({
//   params,
// }: {
//   params: { client: string; site: string };
// }) {
//   const slug = `${params.client}/${params.site}`;
//   return <ProjectDetailsBySlug slug={slug} />;
// }
...
//           <div>
//             <span className="font-medium">Créé le :</span> {meta.meta.created_at}
//           </div>
//           <div>
//             <span className="font-medium">Mis à jour le :</span> {meta.meta.updated_at}
//           </div>

//           <div className="pt-2">
//             <div className="mb-2 font-medium">Métadonnées brutes</div>
